...
function onDeviceReady() {
  ...
  window.plugins.OneSignal.setNotificationOpenedHandler(function (jsonData) {
    ...
    if (
      jsonData.notification.rawPayload &&
      jsonData.notification.rawPayload.custom &&
      jsonData.notification.rawPayload.custom.a &&
      jsonData.notification.rawPayload.custom.a.link &&
      jsonData.notification.rawPayload.custom.a.link !== ''
    ) {
